...
|:--|:--|:--|
| **Set-provider integrity** — a provider serves a forged history, or censors / injects deposits | **Mitigated** | Layer-3 STARK proves the ASP root history is an honest append-only chain; a reordered or leaf-injected history is *unprovable*. Layer-2 completeness proof turns omission into a reported gap. |
